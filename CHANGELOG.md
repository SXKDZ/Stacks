...
- A feed's agent session can be compacted from the feed menu: the same `/compact` the interactive Claude client runs, which shortens what the agent carries between turns while leaving the thread itself untouched.
