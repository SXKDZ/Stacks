...
export const DEFAULT_FEED_SKILLS: FeedSkill[] = [
  ...
  },
  {
    ...
    prompt: [
      ...
      "Then propose each paper as a library change for me to approve; do not claim anything was added, since approval applies it.",
    ].join("\n"),
  },
  {
    id: "reading-list",
  ...
  },
  {
    ...
    icon: "library",
    prompt: [
      "Help me organize papers into collections. READ my library first: the papers and the existing collections.",
